...
if(!checkPermission($group_id, 'user', 'lists_tearch')){
...
require _WEB_PATH_ROOT.'/admin/user/model/board_tearch.php';
...
<div class="container_my">
    ...
    <form action="" method="get" class="mx-0 row">
        ...
        <input type="hidden" name="action" value="lists_tearch">
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item d-<?php echo $page == 1 ? 'none' : 'block'; ?>">
                    <a class="page-link" href="<?php echo "?module=$module&action=lists_tearch$urlFilter&page=$back"; ?>" aria-label="Previous">
                ...
                ?>
                    ...
                    <li class="page-item <?php echo $page == $i ? 'active' : ''; ?>"><a class="page-link" href="<?php echo "?module=$module&action=lists_tearch$urlFilter&page=$i"; ?>"><?php echo $i; ?></a></li>
                ...
                <li class="page-item d-<?php echo $page == $totalPage ? 'none' : 'block'; ?>">
                    <a class="page-link" href="<?php echo "?module=$module&action=lists_tearch$urlFilter&page=$next"; ?>" aria-label="Next">
