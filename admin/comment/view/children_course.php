...
if(!empty($body['id'])){
    ...
    if(!empty($detailComment)){
        ...
        INNER JOIN course as b ON c.course_id = b.id
        INNER JOIN course_type as t ON b.course_type_id = t.id WHERE parent_id='$id' $filter");
    }else{
...
<div class="container_my">
    ...
    <form action="" method="get" class="mx-0 row">
        ...
        <input type="hidden" name="action" value="<?php echo 'children_course'; ?>">
