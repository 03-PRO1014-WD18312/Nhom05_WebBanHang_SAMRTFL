...
if(!empty($body['id'])){
    ...
    require _WEB_PATH_ROOT.'/admin/exam_type/model/fix.php';
...
if(is_Post()){
    ...
    if(empty($errors)){
        ...
        if(update('exam_type', $dataUpdate, "id='$id'")){
    ...
    redirect('?module=exam_type&view=fix&id='.$id);
...
<hr>
<a href="?module=exam_type" class="btn btn-success">Thêm</a>